...
export type PilihAlatProps = KatimScreenProps<'PilihAlat'>;

const PilihAlat: FC<PilihAlatProps> = ({ navigation }) => {
    ...
    <VStack flex={1} bg='spars.green' position='relative'>
      ...
      <ScrollView
        ...
        <HStack py='8' justifyContent='center' alignItems='center' onLayout={e => setHeadHeight(e.nativeEvent.layout.height)}>
          <Text bold color='white' fontSize='16'>Pilih Alat</Text>
