...
const DetailKeluhan: FC<DetailKeluhanProps> = ({ navigation, route }) => {
  ...
  const [catatan, setCatatan] = useState(data.catatan_teknisi || '');
  const [hasil_penanganan, setHasilPenanganan] = useState(data.hasil_penanganan || '');
      ...
      <ScrollView
        ...
        <VStack space='md' py='6' bg='white' borderTopRadius='20' minH={Dimensions.get('window').height - head_height}>
          ...
          <VStack px='6' space='xs'>
            ...
            <TextArea h={40} placeholder='Catatan Teknisi' textAlignVertical='top' isDisabled={data.status === 'Selesai'} value={catatan} onChangeText={setCatatan} />
